...
DROP TABLE IF EXISTS `liber`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `liber` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nomen` varchar(64) NOT NULL,
  `testamentum` tinyint DEFAULT '0',
  PRIMARY KEY (`id`)
...
LOCK TABLES `liber` WRITE;
/*!40000 ALTER TABLE `liber` DISABLE KEYS */;
INSERT INTO `liber` VALUES (1,'EVANGELIUM SECUNDUM MATTHAEUM',1);
/*!40000 ALTER TABLE `liber` ENABLE KEYS */;
UNLOCK TABLES;
